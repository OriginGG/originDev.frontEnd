...
class OriginLandingPageComponentRender extends Component {
    render( ) {
        return (
            <div>
...
OriginLandingPageComponentRender.propTypes = {
    classes: PropTypes.object.isRequired
};

export default injectSheet( GlobalStyles )( OriginLandingPageComponentRender )