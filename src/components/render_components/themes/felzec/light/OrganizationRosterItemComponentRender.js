    ...
    render( ) {
        return (
            <div className={this.props.classes.felzec_staff_image_container}>
                <img className={this.props.classes.felzec_staff_image} src={this.props.roster_image}/>
                <div className={this.props.classes.felzec_staff_overlay} style={this.props.felzec_overlay_style}>
