...
class LightOrganizationAboutModalMobileComponentRender extends Component {
    render( ) {
        return (
            <div className={this.props.classes.blankBG}>
                <div className={this.props.classes.felzec_about_header} style={this.props.bg_style}/>
                <div className={this.props.classes.felzec_about_mobile_container}>
                    <div className={this.props.classes.felzec_about_desc_conatiner} style={this.props.about_desc_style}>
                        ...
                        <div className={this.props.classes.felzec_about_container_lower}>
                            <div className="ui two column grid">
                                ...
                                <div className="column">
                                    <div className={this.props.classes.felzec_lower_mobile_email_button}>
                                        <div className={this.props.classes.felzec_about_email_title}>SUPPORT</div>
                                        <div className={this.props.classes.felzec_about_mobile_email_text} onClick={this.props.handleSupportClick}>{this.props.about_support_email}</div>
                                    </div>
                                    <div className={this.props.classes.felzec_lower_mobile_email_button}>
                                        <div className={this.props.classes.felzec_about_email_title}>MANAGEMENT</div>
                                        <div className={this.props.classes.felzec_about_mobile_email_text} onClick={this.props.handleBusinessClick}>{this.props.about_business_email}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className={this.props.classes.felzec_staff_container}>
                    ...
                    <div className={this.props.classes.felzec_staff_inner_mobile_container}>
                        <div className={this.props.classes.felzec_staff_title}>STAFF</div>
...
LightOrganizationAboutModalMobileComponentRender.propTypes = {
    classes: PropTypes.object.isRequired
};

export default injectSheet( GlobalStyles )( LightOrganizationAboutModalMobileComponentRender )