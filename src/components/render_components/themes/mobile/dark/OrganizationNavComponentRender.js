                    ...
                    <div className="ten wide column">
                        <div className={this.props.classes.obliviot_nav_right}>
                            <div className={this.props.classes.obliviot_org_menu_dark_container}>
                                ...
                                <a href="#">
                                    <div id="menu_blog" className={this.props.classes.org_menu_obliviot_dark_item} style={this.props.blog_style} onClick={this.props.handleBlogClick}>Blog</div>
                                </a>
                                <a href="#">
                                    <div id="roster_button" className={this.props.classes.org_menu_obliviot_dark_item} style={this.props.roster_menu_style} onClick={this.props.handleRosterButtonClick}>Rosters</div>
