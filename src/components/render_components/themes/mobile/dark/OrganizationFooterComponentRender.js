...
class DarkOrganizationFooterComponentRender extends Component {
    render( ) {
        return (
...
DarkOrganizationFooterComponentRender.propTypes = {
    classes: PropTypes.object.isRequired
};

export default injectSheet( GlobalStyles )( DarkOrganizationFooterComponentRender )