...
class DarkOrganizationEmailComponentRender extends Component {
    render( ) {
        return (
            <div>
...
DarkOrganizationEmailComponentRender.propTypes = {
    classes: PropTypes.object.isRequired
};

export default injectSheet( GlobalStyles )( DarkOrganizationEmailComponentRender )