...
class ObliviotOrganizationRosterPageComponentRender extends Component {
    render( ) {
        return (
...
ObliviotOrganizationRosterPageComponentRender.propTypes = {
    classes: PropTypes.object.isRequired
};

export default injectSheet( GlobalStyles )( ObliviotOrganizationRosterPageComponentRender )