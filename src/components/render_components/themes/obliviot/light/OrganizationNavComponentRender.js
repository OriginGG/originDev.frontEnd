                    ...
                    <div className="ten wide column">
                        <div className={this.props.classes.obliviot_nav_right}>
                            <div className={this.props.classes.obliviot_org_menu_light_container}>
                                ...
                                <a href="#">
                                    <div id="sponsers_button" className={this.props.classes.org_menu_obliviot_light_item} style={this.props.sponsers_style} onClick={this.props.handleSponsersClick}>Sponsers</div>
                                </a>
                                <a href="#">
                                ...
                                <a href="#">
                                    <div id="news_button" className={this.props.classes.org_menu_obliviot_light_item}>News</div>
                                </a>
                                <a href="#home_cont">
