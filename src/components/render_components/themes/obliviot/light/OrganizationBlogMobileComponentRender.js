...
class LightOrganizationBlogMobileComponentRender extends Component {
    render( ) {
        return (
            <div>
                <div className={this.props.classes.obliviot_light_news_container} onClick={( ) => {
                    this
                        .props
                    ...
                    <div className={this.props.classes.obliviot_light_main_news_content_container}>
                        ...
                        <div style={{
                            ...
                            <span className={this.props.classes.obliviot_light_news_body}>{this.props.blog_content_1}</span>
                        </div>
                ...
                <div className={this.props.classes.obliviot_light_news_container} onClick={( ) => {
                    ...
                    <div className={this.props.classes.obliviot_light_main_news_content_container}>
                        ...
                        <div style={{
                            ...
                            <span className={this.props.classes.obliviot_light_news_body}>{this.props.blog_content_2}</span>
                        </div>
                        <div className={this.props.classes.obliviot_light_news_decor}/>
                    </div>
                </div>
                <div className={this.props.classes.obliviot_light_news_container} onClick={( ) => {
                    ...
                    <div className={this.props.classes.obliviot_light_main_news_content_container}>
                        ...
                        <div style={{
                            ...
                            <span className={this.props.classes.obliviot_light_news_body}>{this.props.blog_content_3}</span>
                        </div>
                        <div className={this.props.classes.obliviot_light_news_decor}/>
                    </div>
                </div>
