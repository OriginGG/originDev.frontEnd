...
class DarkOrganizationRosterPageComponentRender extends Component {
    render( ) {
        return (
...
DarkOrganizationRosterPageComponentRender.propTypes = {
    classes: PropTypes.object.isRequired
};

export default injectSheet( GlobalStyles )( DarkOrganizationRosterPageComponentRender )