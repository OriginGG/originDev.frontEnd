...
class DarkOrganizationMatchesMobileComponentElementRender extends Component {
    render( ) {
        return (
            <div>
...
DarkOrganizationMatchesMobileComponentElementRender.propTypes = {
    classes: PropTypes.object.isRequired
};

export default injectSheet( GlobalStyles )( DarkOrganizationMatchesMobileComponentElementRender )