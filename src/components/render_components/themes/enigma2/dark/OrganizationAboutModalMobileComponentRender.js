...
class DarkOrganizationAboutModalMobileComponentRender extends Component {
    render( ) {
        return (
...
DarkOrganizationAboutModalMobileComponentRender.propTypes = {
    classes: PropTypes.object.isRequired
};

export default injectSheet( GlobalStyles )( DarkOrganizationAboutModalMobileComponentRender )