...
class DarkOrganizationNewsMobileComponentRender extends Component {
    render( ) {
        return (
            <div>
...
DarkOrganizationNewsMobileComponentRender.propTypes = {
    classes: PropTypes.object.isRequired
};

export default injectSheet( GlobalStyles )( DarkOrganizationNewsMobileComponentRender )