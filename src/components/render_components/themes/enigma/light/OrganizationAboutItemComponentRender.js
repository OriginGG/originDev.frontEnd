...
class ObliviotOrganizationAboutItemComponentRender extends Component {
    render( ) {
        return (
            <div>
...
ObliviotOrganizationAboutItemComponentRender.propTypes = {
    classes: PropTypes.object.isRequired
};

export default injectSheet( GlobalStyles )( ObliviotOrganizationAboutItemComponentRender )