...
class ObliviotOrganizationVideoComponentRender extends Component {
    render( ) {
        return (
...
ObliviotOrganizationVideoComponentRender.propTypes = {
    classes: PropTypes.object.isRequired
};

export default injectSheet( GlobalStyles )( ObliviotOrganizationVideoComponentRender )