...
class ObliviotOrganizationNewsModalComponentRender extends Component {
    render( ) {
        return (
...
ObliviotOrganizationNewsModalComponentRender.propTypes = {
    classes: PropTypes.object.isRequired
};

export default injectSheet( GlobalStyles )( ObliviotOrganizationNewsModalComponentRender )