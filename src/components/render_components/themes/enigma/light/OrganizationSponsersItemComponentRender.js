...
class ObliviotOrganizationSponsersItemComponentRender extends Component {
    render( ) {
        return (
            <div>
                        ...
                        <div className="thirteen wide column">
                            <div style={{
                                ...
                                <div className={this.props.classes.roster_item_name_container}>
                                    <span className={this.props.classes.roster_name}>{this.props.sponser_name}</span>
                                </div>
...
ObliviotOrganizationSponsersItemComponentRender.propTypes = {
    classes: PropTypes.object.isRequired
};

export default injectSheet( GlobalStyles )( ObliviotOrganizationSponsersItemComponentRender )