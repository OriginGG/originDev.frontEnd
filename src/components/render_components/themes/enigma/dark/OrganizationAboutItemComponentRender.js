...
class DarkOrganizationAboutItemComponentRender extends Component {
    render( ) {
        return (
            <div>
...
DarkOrganizationAboutItemComponentRender.propTypes = {
    classes: PropTypes.object.isRequired
};

export default injectSheet( GlobalStyles )( DarkOrganizationAboutItemComponentRender )