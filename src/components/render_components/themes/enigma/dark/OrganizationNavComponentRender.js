                    ...
                    <div className="six wide column">
                        <div className={this.props.classes.nav_left}>
                            <div className={this.props.classes.dark_social_menu_container}>
                                ...
                                <div className={this.props.classes.dark_social_menu_item}>{this.props.social_link2}</div>
                                <div className={this.props.classes.dark_social_menu_item}>{this.props.social_link3}</div>
                                <div className={this.props.classes.dark_social_menu_item}>{this.props.social_link4}</div>
                                <div className={this.props.classes.dark_social_menu_item}>{this.props.social_link5}</div>
                                <div className={this.props.classes.dark_social_menu_item}>{this.props.social_link6}</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="six wide column">
                        <div className={this.props.classes.dark_nav_right}>
                            <div className={this.props.classes.dark_org_menu_container}>
                                <a>
                                    <div id="menu_login" className={this.props.classes.org_menu_dark_item} onClick={this.props.handleLoginClick}>Login</div>
                                </a>
                                <a>
                                ...
                                <a>
                                    <div id="menu_blog" className={this.props.classes.org_menu_dark_item} style={this.props.blog_style} onClick={this.props.handleBlogClick}>Blog</div>
                                </a>
                                <a>
                                ...
                                <a href="#home_cont">
                                    <div id="menu_home" className={this.props.classes.org_menu_dark_item} style={this.props.home_style}>Home</div>
                                </a>
                            </div>
                        </div>
                    </div>
