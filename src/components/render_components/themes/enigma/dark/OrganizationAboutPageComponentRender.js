...
class DarkOrganizationAboutPageComponentRender extends Component {
    render( ) {
        return (
...
DarkOrganizationAboutPageComponentRender.propTypes = {
    classes: PropTypes.object.isRequired
};

export default injectSheet( GlobalStyles )( DarkOrganizationAboutPageComponentRender )