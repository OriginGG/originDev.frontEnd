...
class OrganizationPageComponentRender extends Component {
    render( ) {
        return (
...
OrganizationPageComponentRender.propTypes = {
    classes: PropTypes.object.isRequired
};

export default injectSheet( GlobalStyles )( OrganizationPageComponentRender )