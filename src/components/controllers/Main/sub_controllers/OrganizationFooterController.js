    ...
    render() {
        ...
        for (let i = 0; i < 3; i += 1) {
            if (this.results_array[i]) {
                news_array.push(<OrganizationFooterNewsComponentRender handleNewsClick={this.props.handleNewsClick} blog={this.results_array[i].blog} blog_media={this.results_array[i].media} blog_content={this.results_array[i].title} blog_title={this.results_array[i].blogTitle} />);
            } else {
