				...
				<Card>
					<Card.Content>
						...
						<Card.Description>
							...
							Simply enter the domain name you wish to use, and this will send a support request to our
							team. Once we have received your request, our team will contact you via email to begin the
							process.
						</Card.Description>
					</Card.Content>
					{!this.props.dont_allow && (
						<Card.Content extra>
							<Input
                    ...
                    {this.props.dont_allow && (
                        <Card.Content extra>
                            YOU NEED TO BE SUBSCRIBED TO A PAID PLAN TO USE THIS FEATURE!
                        </Card.Content>
                    )}
				</Card>
			);
		}
		const dm = `Your domain request '${this.state
			.input_value}' has been sent to our support team, we will be in touch shortly.
            Regards, Origin Team.`;
		return (
...
AdminCustomDomainController.propTypes = {
    ...
    dont_allow: PropTypes.bool.isRequired
