...
export const GlobalMobileTheme = {
    colorPrimary: 'green',
...
export const GlobalMobileStyles = GlobalMobileTheme => ({
    // ***************************************************************
    // Global Theme
    // ***************************************************************

    cardContainer: {
        width: GlobalMobileTheme.card_contentWidth,
        height: GlobalMobileTheme.card_contentWidth
    },
    loginContainer: {
        width: GlobalMobileTheme.login_contentWidth,
        height: GlobalMobileTheme.login_contentWidth
    },
    signupContainer: {
        width: GlobalMobileTheme.signup_contentWidth,
        height: GlobalMobileTheme.signup_contentWidth,
        fontFamily: '"Orbitron", sans-serif !important'
    },
    signupHeader: {
        backgroundColor: GlobalMobileTheme.signupHeaderColor,
        padding: '15px'
    },
    signupBGImage: {
    ...
    organizationBG: {
        width: '100%',
        height: '100vh',
        backgroundColor: GlobalMobileTheme.user_styles.lightHeaderColor,
    ...
    organizationHeader: {
        ...
        top: '0',
        left: '0',
        background: GlobalMobileTheme.user_styles.lightHeaderColor,
        borderBottom: '5px solid black'
    },
    organizationFooter: {
        width: '100%',
